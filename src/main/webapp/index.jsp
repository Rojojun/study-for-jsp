...
<section class="container">
    ...
    <div class="card bg-light mt-3">
        <div class="card-header bg-light">
            <div class="row">
                <div class="col-8 text-left">컴퓨터 개론&nbsp;<small>교수명</small></div>
        ...
        <div class="card-body">
            ...
            <p class="card-text">학점은 잘나온다... 그 외는 딱히 모르겠다 타이핑 겁나 빠르네 ㅡㅡ</p>
            <div class="col-9 text-left">
                성적<span style="color: red">A</span>
                재미<span style="color: red">A</span>
            ...
            <div class="modal-body">
                <form action="./evaluationRegisterAction.jsp" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <select name="semesterDivide" class="form-control">
                                ...
                                <option value="1학기">2학기</option>
                                <option value="1학기">여름학기</option>
                                <option value="1학기">겨울학기</option>
                            </select>
                        </div>
                        <div class="form-group col-sm-4">
                            <label>강의 구분</label>
                    ...
                    <div class="form-group">
                        <label>제목</label>
                        <input type="text" name="evaluationTime" class="form-control" maxlength="30px">
                    </div>
                    <div class="form-group">
                        <label>내용</label>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="./reportAction.jsp" method="post">
                                <div class="form-group">
                                    <label>신고 제목</label>
                                    <input type="text" name="reportTitle" class="form-control" maxlength="30px">
                                </div>
                                <div class="form-group">
                                    <label>신고 내용</label>
...
<footer class="bg-dark mt-4 p-5 text-center" style="color: #ffffff;">
    Copyright &copy; me All Rights Reserved.
</footer>
